            ...
            <Header style={styles.header}>
                <Menu theme="light" mode="horizontal" style={styles.menu}>
                    <Menu.Item
                        ...
                        key="setting:1"><Link to="/manageapp">Quản lý App</Link>
                    </Menu.Item>
                </Menu>
            </Header>
        )
            ...
            >
                <Menu theme="light" mode="horizontal" style={styles.menu}>
                    ...
                    <SubMenu icon={<PaperClipOutlined />} title="Minh chứng">
                        ...
                        <Menu.Item key="setting:9" style={styles.menuItem}><Link to="/previewminhchung">Xem tập tin minh chứng</Link></Menu.Item>
                    </SubMenu>
        ...
        return (
            <Header style={styles.header}>
                <Menu theme="light" mode="horizontal" style={styles.menu}>
                    <Menu.Item
                        icon={<CalendarOutlined />}
                        key="setting:1"><Link to="/managetasks">Quản lý công việc</Link>
                    </Menu.Item>
                    <Menu.Item
                        icon={<PaperClipOutlined />}
                        key="setting:2"><Link to="/manageminhchungs">Quản lý minh chứng</Link>
                    </Menu.Item>
                </Menu>
        ...
        return (
            <Header style={styles.header}>
                <Menu theme="light" mode="horizontal" style={styles.menu}>
                    <Menu.Item
                        icon={<CalendarOutlined />}
                        key="setting:1"><Link to="/manageschools">Quản lý Trường</Link></Menu.Item>
                </Menu>
            </Header>
        )
    }
