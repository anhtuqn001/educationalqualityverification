...
const TieuchiDetails = ({ tieuchiId }) => {
    ...
    const exportFile = () => {
        window.location.href = '/api/createpxdnhm4/' + tieuchiId ;
    }
    ...
    function getIframeLink() {
        console.log('load');
        return `https://docs.google.com/gview?url=https://vuonxanh.lihanet.com/api/createpxdnhm4/${tieuchiId}&embedded=true`;
    }
