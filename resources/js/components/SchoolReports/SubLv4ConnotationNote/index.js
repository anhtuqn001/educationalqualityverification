...
const SubLv4ConnotationNote = ({ nienkhoaId }) => {
    ...
    const handleTieuchiSelect = (id) => {
       ...
       if(tieuchi) {
           setCurrentTieuchiId(tieuchi.id);
       }
    }
    ...
    return (
        <React.Fragment>
            <Row gutter={16}>
                ...
                <Col span={18}>
                    {currentTieuchiId && <TieuchiDetails tieuchiId={currentTieuchiId}/>}
                </Col>
            </Row>
        </React.Fragment >
    );
...
export default SubLv4ConnotationNote;
